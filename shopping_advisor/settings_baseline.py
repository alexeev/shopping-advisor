...
:mod:`shopping_advisor.settings` for the profile and
:mod:`shopping_advisor.settings_scrapeops` for the optional proxy integration.
"""

from shopping_advisor.settings import *  # noqa: F401,F403
